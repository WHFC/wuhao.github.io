...
contract UniswapMarket {
    ...
    address private constant router = 0xa85233C63b9Ee964Add6F2cffe00Fd84eb32338f;
    address private constant WETH = 0x322813Fd9A801c5507c9de605d63CEA4f2CE6c44;
    address private constant A = 0x07882Ae1ecB7429a84f1D53048d35c4bB2056877;
    address private constant B = 0x22753E4264FDDc6181dc7cce468904A80a363E44;
    mapping(address => mapping(address => uint256)) public tokenBalances;
    bool private inTransaction;

    modifier transactionLocker() {
        require(!inTransaction, "UniswapMarket: Trading");
        inTransaction = true;
        _;
        inTransaction = false;
    }

    // msg.sender先调用tokenA的approve，授权给market合约amount数额，再调用depositTokenA将代币存入market（在market）
    ...
    function depositToken(address token, uint256 amount) internal transactionLocker returns (bool result) {
    ...
    function buyToken(address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOutMin, address to) internal transactionLocker returns (uint[] memory) {
