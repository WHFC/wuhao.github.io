...
contract UniswapMarket {
        ...
        returns (uint amountA, uint amountB, uint liquidity)
    {
        ...
        require(depositToken(A, amountADesired), "UniswapMarket: deposit tokenA failed");
        require(depositToken(B, amountBDesired), "UniswapMarket: deposit tokenB failed");
    ...
    function approveToRouter(address token, uint256 amount) internal returns (bool result) {
    ...
    function buyToken(
        ...
        require(address(0) != to, "UniswapMarket: address to invalid");
        require(depositToken(tokenIn, amountIn), "UniswapMarket: deposit failed");
