/**
 *Submitted for verification at hecoinfo.com on 2021-05-01
*/

/**
 *Submitted for verification at hecoinfo.com on 2021-05-1
*/

/**
   #HBY token
   
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #HBY  

    I make this #Mat to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/HBYTokenHECO
   ...
   I will renounce the ownership to burn addresses to transfer #HBY to the community, make sure it's 100% safe.

   I will add 1 HT and all the left 49% total supply to the pool
   Can you make #HBY 100X? 
   ...
   it's the best part of the #Door idea, increasing the liquidity pool automatically, 
...
contract DogToken is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000000 * 10**6 * 10**18;
